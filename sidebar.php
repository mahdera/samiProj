<div class="sb-slidebar sb-left sb-style-push">
    ...
    <div id="slidecontent">
        ...
        <ul class="reveal">
            <li><a href="#.php" id="step1_1MenuLink">Step 1-1</a></li>
            <li><a href="#.php" id="step1_2MenuLink">Step 1-2</a></li>
            <li><a href="#.php" id="step1_3MenuLink">Step 1-3</a></li>
            <li><a href="#.php" id="step1_4MenuLink">Step 1-4</a></li>
        </ul>
        <h3 class="clicker" id="stepTwoMenuLink">Step 2</h3>
        <ul class="reveal">
            <li><a href="#.php" id="step2_1MenuLink">Step 2-1</a></li>
            <li><a href="#.php" id="step2_2MenuLink">Step 2-2</a></li>
            <li><a href="#.php" id="step2_3MenuLink">Step 2-3</a></li>
            <li><a href="#.php" id="step2_4MenuLink">Step 2-4</a></li>
        </ul>
        <h3 class="clicker" id="stepThreeMenuLink">Step 3</h3>
        <ul class="reveal">
            <li><a href="#.php" id="step3_1MenuLink">Step 3-1</a></li>
            <li><a href="#.php" id="setp3_2MenuLink">Step 3-2</a></li>
            <li><a href="#.php" id="step3_3MenuLink">Step 3-3</a></li>
            <li><a href="#.php" id="step3_4MenuLink">Step 3-4</a></li>
        </ul>
        <h3 class="clicker" id="stepFourMenuLink">Step 4</h3>
        <ul class="reveal">
            <li><a href="#.php" id="step4_1MenuLink">Step 4-1</a></li>
            <li><a href="#.php" id="setp4_2MenuLink">Step 4-2</a></li>
            <li><a href="#.php" id="step4_3MenuLink">Step 4-3</a></li>
            <li><a href="#.php" id="step4_4MenuLink">Step 4-4</a></li>
        </ul>
        <h3 class="clicker" id="stepFiveMenuLink">Step 5</h3>
        <ul class="reveal">
            <li><a href="#.php" id="step5_1MenuLink">Step 5-1</a></li>
            <li><a href="#.php" id="step5_2MenuLink">Step 5-2</a></li>
            <li><a href="#.php" id="step5_3MenuLink">Step 5-3</a></li>
            <li><a href="#.php" id="step5_4MenuLink">Step 5-4</a></li>
        </ul>
        <h3 class="clicker" id="stepSixMenuLink">Step 6</h3>
        <ul class="reveal">
            <li><a href="#.php" id="step6_1MenuLink">Step 6-1</a></li>
            <li><a href="#.php" id="step6_2MenuLink">Step 6-2</a></li>
            <li><a href="#.php" id="step6_3MenuLink">Step 6-3</a></li>
            <li><a href="#.php" id="step6_4MenuLink">Step 6-4</a></li>
            <li><a href="#.php" id="step6_5MenuLink">Step 6-5</a></li>
        </ul>
    </div>
    <div class="savequit">
        <ul class="sq">
