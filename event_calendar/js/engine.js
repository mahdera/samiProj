$(document).ready(function() {
   ...
   $calendar.weekCalendar({
      ...
      eventNew : function(calEvent, $event) {
         ...
         var locationField = $dialogContent.find("textarea[name='location']");
      ...
      eventClick : function(calEvent, $event) {
         ...
         var locationField = $dialogContent.find("textarea[name='location']");
         locationField.val(calEvent.location);
         ...
         $dialogContent.dialog({
            ...
            buttons: {
               save : function() {
                  ...
                  "&id="+calEvent.id+"&location="+encodeURIComponent(calEvent.location);
                  //stopped right here...
                  $.ajax({
                    url: 'event_calendar/events.php',
                    data: dataString,
      ...
      data : "event_calendar/events.php?action=read"
   });
