    ...
    <div id="rightcontain">
        <div id="listdiv">
            <ul class="ld">
                ...
                <li><a href="#" id="logoutLink1">Logout</a></li>
            </ul>
        </div>
    </div>
    <?php
    ...
    <div id="rightcontain">
        <div id="listdiv" style="padding-botton: 5px;">
            <ul class="ld">
                ...
                <!--<li><a href="#.php" id="contentManagementLink">Content</a></li>-->
                <li><a href="#.php" id="userManagementLink">User</a></li>
                <li><a href="#.php" id="logoutLink1">Logout</a></li>
            </ul>
        </div>
    </div>
    <?php
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#contentManagementLink').click(function(){
            $('#myAccountDiv').load('files/showcontentmanagementlist.php', {noncache: new Date().getTime()});
        });

        $('#userManagementLink').click(function(){
            $('#myAccountDiv').load('files/showusermanagementlist.php', {noncache: new Date().getTime()});
        });

        $('#accountManagementLink').click(function(){
            $('#myAccountDiv').load('files/showmyaccountinnermenu.php', {noncache: new Date().getTime()});
        });

        $('#reportManagementLink').click(function(){
            $('#myAccountDiv').load('files/showreportmanagementpage.php', {noncache: new Date().getTime()});
        });

        $('#logoutLink1').click(function(){
