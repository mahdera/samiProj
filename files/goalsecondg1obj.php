<?php
    ...
    function updateGoalSecondG1Obj($id, $goalSecondG1Id, $obj, $modifiedBy){
        try{
            $query = "update tbl_goal_second_g1_obj set goal_second_g1_id = $goalSecondG1Id, obj='$obj', modified_by = $modifiedBy, modification_date = NOW() where id = $id";            
            save($query);
        } catch (Exception $ex) {
            $ex->getMessage();
        }
