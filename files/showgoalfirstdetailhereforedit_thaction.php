...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var thActionControlName = "textareathaction" + thId;
        ...
        $('#'+buttonId).click(function(){
            ...
            if(true){
                ...
                if( $('#'+thActionControlName).length ){
                    dataString += "&"+thActionControlName+"="+$('#'+thActionControlName).val();
                }else{
                    dataString += "&"+thActionControlName+"="+null;
                }
