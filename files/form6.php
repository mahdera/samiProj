<?php
    ...
    function getLatestForm6ModifiedByUsingUserLevelResultSet($userLevel, $divisionId){
      try{
        $query = null;
        if($userLevel == '02'){
    ...
    function checkIfForm6RecordIsAlreadyEntered($userLevel, $divisionId){
      try{
        $query = null;
        $cnt = 0;
        if($userLevel == '02'){
          $query = "select count(*) as cnt from tbl_form_6, tbl_user_sub_district where " .
          "tbl_form_6.modified_by = tbl_user_sub_district.user_id and " .
