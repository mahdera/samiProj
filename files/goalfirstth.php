<?php
    ...
    function hasThisThBeenUsedForGoalFirstByUsingUserLevel($thId, $userLevel, $divisionId){
        $cntVal = 0;
        try{
            if($userLevel = '02'){
    ...
    function getAllFilteredSelectedThIds($selectedThIdArray, $divisionId){
        try{
            $query = "select tbl_goal_first_th.th_id from tbl_goal_first_th, tbl_user_sub_district " .
