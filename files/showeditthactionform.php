...
<form>
    ...
    <table border="0" width="100%">
        <tr>
            ...
            <td>
                <textarea name="<?php echo $thEditActionText;?>" id="<?php echo $thEditActionText;?>" rows="3" style="width:100%" ><?php echo $thActionObj->action_text;?></textarea>
            </td>
        </tr>
    </table>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var thEditActionText = "thEditActionText" + thActionId;
        ...
        $('#'+buttonId).click(function(){
            ...
            var thEditActionTextVal = $('#' + thEditActionText).val();
            ...
            divId = "editActionTextDiv" + thActionId;
            ...
            if(true){
                ...
                "&thActionId="+thActionId+"&thEditActionText="+thEditActionTextVal;
