<?php
    ...
    $thEditActionText = mysql_real_escape_string($_POST['thEditActionText']);
    ...
    for($i=1; $i<=$goalFirstG1Ctr; $i++){
        ...
        $goalFirstG1ObjVal = mysql_real_escape_string($_POST["$goalFirstG1ObjControlName"]);
        $goalFirstG1FnVal = mysql_real_escape_string($_POST["$goalFirstG1FnControlName"]);
    ...
    for($j=1; $j<=$goalFirstG2Ctr; $j++){
        ...
        $goalFirstG2ObjVal = mysql_real_escape_string($_POST["$goalFirstG2ObjControlName"]);
        $goalFirstG2FnVal = mysql_real_escape_string($_POST["$goalFirstG2FnControlName"]);
    ...
    for($k=1; $k<=$goalFirstG3Ctr; $k++){
        ...
        $goalFirstG3ObjVal = mysql_real_escape_string($_POST["$goalFirstG3ObjControlName"]);
        $goalFirstG3FnVal = mysql_real_escape_string($_POST["$goalFirstG3FnControlName"]);
