...
<form id="goalFirstManagementForm">
  <fieldset>
    ...
    <table border="0" width="100%">
      ...
      <tr id="addMoreG1ObjFn1" style="background: #C6E2FF">
      ...
      <tr id="addMoreG3ObjFn1" style="background: #C6E2FF">
        <td colspan="2" align="right">
...
$(document).ready(function(){
    $('#btnsave').click(function(){
      ...
      var th = "<?php echo $thId;?>";//$('#slctth').val();
      var g1 = $('#txtg1').val();
      ...
      $('.fnRefreshSpin').click(function(){
            ...
            //I think It would be better to remove the element and create it via jquery again
            //later.......
