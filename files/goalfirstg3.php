<?php
    ...
    function getAllGoalFirstG3ForThisGoalFirstIdAndModifiedBy($goalFirstId, $modifiedBy){
        try{
            $query = "select * from tbl_goal_first_g3 where goal_first_id = $goalFirstId and modified_by = $modifiedBy";
            $result = read($query);
            return $result;
        } catch (Exception $ex) {
            $ex->getMessage();
