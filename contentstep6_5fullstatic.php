<div class="content" id='step1Content'>
  ...
  <div id="topcontain">
    ...
    <div id="resourcearea">
      <ul>
        <li class="sb-toggle-right" id="step6_5"><img src="images/resource_icon.png" alt="Resource Toolkit" /> Resource Toolkit</li>
      </ul>
    </div>
  </div>
...
window.location.replace('step6_4fullstatic.php');
});
