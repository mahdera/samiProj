...
$section->addTitle('Form 1', 2);
$section->addTitle('Question 1', 3);
if($form1Obj){
    $section->addText($form1Obj->q1);
}
$section->addTitle('Question 2', 3);
if($form1Obj){
    $section->addText($form1Obj->q2);
}
$section->addTitle('Form 1 Question 3 and 4', 3);
...
$section->addTitle('Summary of Change', 3);
...
$section->addTitle('Form 3, Question 3.1', 2);
if($form3Obj){
...
$section->addTitle('Form 4. Question 4.1', 2);
if($form4Obj){
...
$section->addTitle('Form 5. Question 5.1', 2);
if($form5Obj){
...
$section->addTitle('Form 6. Question 6.1', 2);
if($form6Obj){
...
$section->addTitle('Form 7. Question 7.1', 2);
if($form7Obj){
...
$section->addTitle('Form 8. Question 8.1', 2);
if($form8Obj){
...
$section->addTitle('Form 9. Question 9.1', 2);
if($form9Obj){
...
$section->addTitle('Form 10. Question 10.1', 2);
if($form10Obj){
...
//---------------------------------------------------------------------------------------------------------
$fnIdArray = array();
$section->addTitle('Goal Second', 1);
    ...
    while($goalSecondFnRow = mysql_fetch_object($goalSecondFnList)){
        ...
        if(!empty($goalSecondG1Row)){
            ...
            if(!empty($goalSecondG1ObjList)){
                ...
                }//end goalSecondG1ObjRow while loop
            }
        }
        ...
        if(!empty($goalSecondG2Row)){
            ...
            $section->addText($goalSecondG2Row->g2);
            $goalSecondG2ObjList = getAllGoalSecondG2ObjsForThisGoalSecondG2Id($goalSecondG1Id);
            if(!empty($goalSecondG2ObjList)){
                while($goalSecondG2ObjRow = mysql_fetch_object($goalSecondG2ObjList)){
                    ...
                    //$section->addText('Obj');
                    $section->addText($goalSecondG2ObjRow->obj);
                }//end goalSecondG1ObjRow while loop
            }
        }
        ...
        if(!empty($goalSecondG3Row)){
            ...
            $section->addText($goalSecondG3Row->g3);
            ...
            if(!empty($goalSecondG3ObjList)){
                while($goalSecondG3ObjRow = mysql_fetch_object($goalSecondG3ObjList)){
                    ...
                    //$section->addText('Obj');
                    $section->addText($goalSecondG3ObjRow->obj);
                }//end goalSecondG1ObjRow while loop
            }
        }
        ...
        while($fnActionRow = mysql_fetch_object($fnActionList)){
            $section->addText($fnActionRow->action_text);
        }//end while loop for fn action list...
    }//end inner while loop

}//end goal second while...loop

//---------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------
$section->addTitle('Goal First', 1)  ;
